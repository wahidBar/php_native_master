<?php
require_once BASE_PATH.'/models/SatuanModel.php';
...
class SatuanController extends BaseController {
    ...
    public function __construct(){
        global $pdo;
        $this->model = new SatuanModel($pdo);
    }
    ...
    public function index(){
        ...
        $this->render('satuan/index',[], 'main');
    }

    public function create(){
        $this->render('satuan/form',[],null);
    }
    ...
    public function edit(){
        ...
        $this->render('satuan/form',['data'=>$data],null);
    }
